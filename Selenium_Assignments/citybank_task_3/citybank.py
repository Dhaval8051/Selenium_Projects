...
def runner():
    ...
    driver.find_element(By.XPATH, "//input[@id='citiCard1']").send_keys("1234")

    driver.find_element(By.XPATH, "//input[@id='citiCard2']").send_keys("5678)

    driver.find_element(By.XPATH, "//input[@id='citiCard3']").send_keys("8051")

    driver.find_element(By.XPATH, "//input[@id='citiCard4']").send_keys("7654")

    driver.find_element(By.XPATH, "//input[@id='cvvnumber']").send_keys("9321")
